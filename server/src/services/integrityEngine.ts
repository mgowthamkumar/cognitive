import { IntegritySignalResult } from '../types.js';
...
export class IntegritySignalEngine {
  /**
   ...
   */
  public evaluateIntegrity(telemetry: SubmissionTelemetry): IntegritySignalResult {
    ...
    let status: 'normal' | 'unusual' | 'needs_review' = 'normal';
...
export const integrityEngine = new IntegritySignalEngine();

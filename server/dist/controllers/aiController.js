...
exports.requestProgressiveHint = exports.askAiAssistant = void 0;
...
const askAiAssistant = async (req, res) => {
    try {
        const { question, language, level, topic, cognitive_load, tutor_mode = 'EXPLAIN', code_context } = req.body;
        const userId = req.user?.id || 'guest_user';
        // Extract user profile context (Section 66)
        const weakList = database_js_1.dbService.getWeakConcepts(userId).map(w => w.concept_name);
 ...
 */
const requestProgressiveHint = async (req, res) => {
    try {
...
exports.requestProgressiveHint = requestProgressiveHint;
